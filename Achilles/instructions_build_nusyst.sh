...
# Step 4: Setup UPS softwares
	...
	# Export GENIE Libraries
	export LD_LIBRARY_PATH=/exp/dune/app/users/mazam/production/event_generators/BuildEventGenerators/Generator/lib:$LD_LIBRARY_PATH
	
	# Export Nuisflat
	export NUISANCE=/exp/dune/app/users/mazam/production/event_generators/BuildEventGenerators/nuisance
	export LD_LIBRARY_PATH=$NUISANCE/build/Linux/lib64:$LD_LIBRARY_PATH

	# Add other needed deps
	export LD_LIBRARY_PATH=/exp/dune/app/users/mazam/production/event_generators/BuildEventGenerators/Generator/lib:$LD_LIBRARY_PATH
	...
	export LD_LIBRARY_PATH=/cvmfs/larsoft.opensciencegrid.org/products/libxml2/v2_9_12/Linux64bit+3.10-2.17-e20-prof/lib:$LD_LIBRARY_PATH
	export LD_LIBRARY_PATH=/cvmfs/larsoft.opensciencegrid.org/products/geant4/v4_11_2_p02/Linux64bit+3.10-2.17-c14-prof/lib:$LD_LIBRARY_PATH
	export LD_LIBRARY_PATH=/cvmfs/larsoft.opensciencegrid.org/products/clhep/v2_4_7_1/Linux64bit+3.10-2.17-c14-prof/lib:$LD_LIBRARY_PATH



# Step 5: Build Nusystematics
	./build_nusyst.sh
	
# Step 6.1: Confirm nusystematics build
# You should see things like: setup.nusystematics.sh, GenerateSystProviderConfigNuSyst, DumpConfiguredTweaksNuSyst
	ls /exp/dune/app/users/mazam/production/event_generators/BuildEventGenerators/nusystematics/build/Linux/bin

# Step 6.2: Also check the libraries:
# You should see .so files such as: libnusystematics_systproviders.so, libsystematicstools_interface.so, libsystematicstools_utility.so
	ls /exp/dune/app/users/mazam/production/event_generators/BuildEventGenerators/nusystematics/build/Linux/lib
